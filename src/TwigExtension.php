    ...
    public function getFunctions()
    {
        return [
            ...
            new \Twig_SimpleFunction('getToken', function () {
                return \RunBB\Core\Random::hash(User::get()->id.Random::hash(Container::get('utils')->getIp()));
            }, ['is_safe' => ['html']]),
            ...
            new \Twig_SimpleFunction('formatNumber', function ($var) {
                return Container::get('utils')->numberFormat($var);
            }, ['is_safe' => ['html']]),
            ...
            new \Twig_SimpleFunction('formatTitle', function ($title, $name = '', $groupTitle = '', $gid = '') {
                return Container::get('utils')->getTitle($title, $name, $groupTitle, $gid);
            }, ['is_safe' => ['html']]),
            ...
            new \Twig_SimpleFunction('breadcrumbsAdmin', function (array $links) {
                return \RunBB\Core\AdminUtils::breadcrumbsAdmin($links);
            }, ['is_safe' => ['html']]),
